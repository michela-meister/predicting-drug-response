...
def fit_k(seed, k, use_real_data, data_fn, obs_name):
    ...
    rsq_test = get_r_squared(s_loc, d_loc, s_test_idx, d_test_idx, obs_test.numpy())
    rsq_train = get_r_squared(s_loc, d_loc, s_idx, d_idx, obs_train.numpy())
